...
const ApiGuide = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-5 font-sans w-full lg:w-4/5">
      <h1 className="text-xl md:text-2xl text-center text-white mb-6">
...
export default BlogPosts;
        ...
        <div className="flex-1 bg-[#111111fd] border border-[#1f1e1e] p-4 rounded-lg">
          <h2 className="text-lg ">API Tester</h2>
          <p className="text-sm">
          ...
          <input
            ...
            className="w-full p-2 mt-[15px] mb-4 bg-[#1b1b1bfd] border border-[#353434]  rounded focus:outline-none text-xs md:text-sm"
          />
          <button
            onClick={testApi}
            className="w-full md:w-auto px-4 py-2 bg-[#4f7dfa] text-white rounded  focus:outline-none"
          >
            Test API
          </button>
          {error && (
          ...
          {apiResponse && (
            <div className="bg-[#1b1b1b] text-blue-300 p-4 rounded mt-4 overflow-x-auto overflow-y-auto max-h-[250px] md:max-h-[350px] lg:max-h-[450px] text-xs md:text-sm max-w-full lg:max-w-[600px]">
